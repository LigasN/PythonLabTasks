...
##############################################################################
def number_of_file():
    start_path = r'D:\\Nazwa_pliku\\Nazwa_pliku\\Nazwa_pliku'  # tutaj wpisujemy swoją ścieżkę do katalogu
    files_to_count = os.listdir(start_path)
    print("W pliku o ścieżce " + start_path + " znajduje sie " + str(len(files_to_count)) + " pliki")
...
def directory_structure():
    ...
    start_path = r'D:\\Nazwa_pliku\\Nazwa_pliku\\Nazwa_pliku'  # tutaj wpisujemy swoją ścieżkę do katalogu
    end_path = r'D:\ '  # koniec wypisywania zawartości plików

    while start_path != end_path[:-1]:
        print(start_path)
        print('\n'.join(os.listdir(start_path)))
...
def conversion_extension():
    path = r'D:\\Nazwa pliku\\Nazwa pliku'  # tutaj wpisujemy ścieżke do katalogu ze zdjęciami
